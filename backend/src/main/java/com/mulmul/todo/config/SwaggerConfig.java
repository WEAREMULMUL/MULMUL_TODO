package com.mulmul.todo.config;
...
public class SwaggerConfig {
    private static final String PROJECT_NAME = "MULMUL_TODO";
    private static final String GITHUB_URL = "https://github.com/DongGeon0908/MULMUL_TODO";
    private static final String DEVELOPER_EMAIL = "wrjs@naver.com";
    private static final String API_TITLE = "MULMUL_REST_API";
